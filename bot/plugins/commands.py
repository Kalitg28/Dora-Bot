...
@Client.on_message(filters.command(["start"]) & (filters.private | filters.group), group=3)
...
@Client.on_message(filters.command(["map"]) & (filters.private | filters.group), group=3)
