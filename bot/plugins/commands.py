...
async def get_json(bot:Client, update:Message):
    ...
    await update.reply_text("<code>♡ generated by :</code> @Dora_MV_Bot", parse_mode='html')
    ...
    if file_uid:
        ...
        if fsub:
                    ...
                    try:
                        ...
                        link = chat.invite_link
                        if not fsub_msg:
                            buttons = [[InlineKeyboardButton("Join 🤓", url=link),InlineKeyboardButton("Retry ♻️", url=f"http://t.me/Dora_MV_Bot?start={file_uid}")]]
                            await update.reply(
                            text="<b>Sorry Man You'll Have To Join My Channel First To Use Me 🙂🙂\n\nJust Click On The Join Button Below And Come Back And Click On Retry......</b>",
                            quote=True,
                            reply_markup=InlineKeyboardMarkup(buttons)
